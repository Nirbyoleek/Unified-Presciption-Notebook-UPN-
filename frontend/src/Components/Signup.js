      ...
      <form className="flex" onSubmit={handleSubmit}>
        <div className="w-[50vw]">
          ...
          <div data-aos="zoom-in" data-aos-duration="2000">
            ...
            <div className="px-40 pt-12 flex ">
              <div className="form-check ml-8 mr-12  cursor-pointer">
                <input type="checkbox" className="mx-2 "></input>
                <label className="text-[#23776e] font-extrabold">Admin</label>
              </div>
              <div className="form-check cursor-pointer">
                <input type="checkbox" className="mx-2"></input>
                <label className="text-[#23776e] font-extrabold">Patient</label>
              </div>
              {/* <div class="relative border-b-2 p-2 focus-within:border-[#23776E] flex">
                <input
                  type={show ? "text" : "password"}
